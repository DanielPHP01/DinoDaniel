...
public class Dino {
  ...
  public void setImagePaths(String standPath, String leftFootPath, String rightFootPath, String deadPath) {
    image = new Resource().getResourceImage(standPath);
    leftFootDino = new Resource().getResourceImage(leftFootPath);
    rightFootDino = new Resource().getResourceImage(rightFootPath);
    deadDino = new Resource().getResourceImage(deadPath);
  }
