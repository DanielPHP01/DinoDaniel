...
public class Obstacles {
  ...
  public Obstacles(int firstPos) {
    ...
    imageList.add(new Resource().getResourceImage("Cactus-1.png"));
    imageList.add(new Resource().getResourceImage("Cactus-2.png"));
    imageList.add(new Resource().getResourceImage("Cactus-3.png"));
    imageList.add(new Resource().getResourceImage("Cactus-4.png"));
    imageList.add(new Resource().getResourceImage("Cactus-5.png"));
  ...
  public void update() {
    ...
    if (firstOb.x < -firstOb.image.getWidth()) {
      ...
      System.out.println(obstacleInterval);
    }
  }
  ...
  public void setImagePaths(ArrayList<String> imagePaths) {
    ...
    for (String imagePath : imagePaths) {
      imageList.add(new Resource().getResourceImage(imagePath));
    }
  ...
  public void setObstacleIntervalAndSpeed(int obstacleInterval, int movementSpeed) {
    setObstacleInterval(obstacleInterval);
